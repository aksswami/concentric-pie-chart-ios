...
class ASPieChartCircle: NSObject {
    ...
    func initializeValues() {
        ...
        for (index, dataItem) in dataItems.enumerate() {
            ...
            dataItem.itemPercentage = Double(endPercentageForItemAtIndex(index) - startPercentageForItemAtIndex(index))
            ...
            let centerPercentageAngle: Double = centerPercentage * (M_PI * 2) - M_PI_2
